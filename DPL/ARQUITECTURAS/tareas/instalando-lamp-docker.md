...
## Se pide
  ...
  Realizar la construcción de los contenedores docker, con el fin de poder desplegar cualquier de las aplicaciones creadas por el alumno en la asignatura de __servidor__.

## Realiza el Informe

  Realiza un informe indicando los pasos que has seguido para la instalación y se muestre la creación de los contenedores para __LAMP__ en __Docker__, verificando el despliegue de la aplicación seleccionada, así como el acceso correcto a __phpmyadmin__.
